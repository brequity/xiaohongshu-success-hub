  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-coral-light/20 to-coral/10 -z-10" />
        <div className="absolute inset-0 bg-[url('/lovable-uploads/2bc9c4e5-8efa-47e6-ab5c-a2b76d1fe92c.png')] bg-cover bg-center opacity-10 -z-20" />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-coral to-coral-light bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              ...
              >
                <h3 className="text-4xl font-bold text-coral mb-2">{stat.number}</h3>
